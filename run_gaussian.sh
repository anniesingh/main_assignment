...
#SBATCH --job-name=main_assignment
...
g16 Molecule_TETCEN_SP.com                      # Run Gaussian calculation for molecule 1
g16 Molecule_PENCEN_SP.com                      # Run Gaussian calculation for molecule 2
